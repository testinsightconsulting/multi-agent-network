...
from device_agent_mesh.cli.agent_cli import _create_agents_from_simple_topology, _build_topology_overview
...
async def run_demo():
    ...
    with patch('device_agent_mesh.cli.agent_cli.GenericSshDeviceInterface') as MockSSH:
        mock_ssh = MagicMock()
